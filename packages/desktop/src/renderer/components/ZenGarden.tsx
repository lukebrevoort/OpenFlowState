export function ZenGarden() {
  return (
    <div
      className="absolute inset-0 overflow-hidden pointer-events-none select-none zen-drift z-0"
      aria-hidden="true"
    >
      ...
      <div
        className="absolute top-1/4 right-20 animate-float-medium opacity-25"
      ...
      <div
        className="absolute bottom-1/3 left-1/4 animate-float-slow opacity-20"
        style={{ animationDelay: '4s' }}
      >
        <svg width="35" height="35" viewBox="0 0 35 35" fill="none">
          <path
            d="M17.5 5 C 26 9, 30 17.5, 26 26 C 21 30, 14 30, 9 26 C 5 17.5, 9 9, 17.5 5 Z"
            fill="var(--fs-zen-ember)"
            opacity="0.6"
          />
        </svg>
      </div>
      ...
      <div
        className="absolute top-1/2 right-1/3 animate-float-medium opacity-25"
      ...
      <div
        className="absolute bottom-20 right-1/4 animate-float-slow opacity-30"
      ...
      <div className="absolute top-0 left-1/3 opacity-10">
        <svg width="60" height="400" viewBox="0 0 60 400" fill="none">
          <line
            ...
            className="animate-sway-gentle"
          />
          <line x1="30" y1="100" x2="50" y2="100" stroke="var(--fs-zen-ink)" strokeWidth="2" />
          <line x1="30" y1="200" x2="50" y2="200" stroke="var(--fs-zen-ink)" strokeWidth="2" />
          <line x1="30" y1="300" x2="50" y2="300" stroke="var(--fs-zen-ink)" strokeWidth="2" />
        </svg>
      </div>
      ...
      <div className="absolute top-0 right-1/4 opacity-10">
        <svg width="60" height="400" viewBox="0 0 60 400" fill="none">
          <line
            ...
            style={{ animationDelay: '1s' }}
          />
          <line x1="30" y1="120" x2="10" y2="120" stroke="var(--fs-zen-ink)" strokeWidth="2" />
          <line x1="30" y1="240" x2="10" y2="240" stroke="var(--fs-zen-ink)" strokeWidth="2" />
        </svg>
      </div>
    </div>
  );
