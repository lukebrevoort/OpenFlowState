...
app.post('/api/auth/google/exchange', async (req, res) => {
  ...
  try {
    ...
    if (isGmail) await auth.storeClientConfig('gmail', { clientId, clientSecret, redirectUri });
    if (isCalendar) await auth.storeClientConfig('gcal', { clientId, clientSecret, redirectUri });
