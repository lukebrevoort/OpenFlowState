export function ZenGarden() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Gentle branches growing from corners */}
      <div className="absolute top-0 right-0 opacity-15">
        <svg width="300" height="300" viewBox="0 0 300 300" fill="none">
          ...
          <circle cx="230" cy="100" r="6" fill="#A5B574" opacity="0.5" className="animate-pulse-gentle" style={{ animationDelay: '0.3s' }} />
        </svg>
      </div>
      ...
      <div className="absolute bottom-0 left-0 opacity-15">
        <svg width="300" height="300" viewBox="0 0 300 300" fill="none">
          ...
          <circle cx="80" cy="220" r="5" fill="#A5B574" opacity="0.5" className="animate-pulse-gentle" style={{ animationDelay: '0.4s' }} />
        </svg>
      </div>

      {/* Subtle bamboo-like stems */}
      ...
      <div className="absolute top-0 right-1/4 opacity-10">
        <svg width="60" height="400" viewBox="0 0 60 400" fill="none">
          <line x1="30" y1="0" x2="30" y2="400" stroke="#3E2F27" strokeWidth="4" className="animate-sway-gentle" style={{ animationDelay: '1s' }} />
